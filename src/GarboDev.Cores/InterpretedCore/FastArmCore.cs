...
namespace GarboDev.Cores.InterpretedCore
{
    public partial class FastArmCore
    {
        ...
        private readonly ExecuteInstructionDelegate[] NormalOps;
        ...
        public FastArmCore(Arm7Processor parent, Memory memory)
        {
            ...
            NormalOps = new ExecuteInstructionDelegate[8]
                {
        ...
        public void Step()
        {
            ...
            if (cond == 1)
            {
                ...
                ExecuteInstruction((ushort)(((curInstruction >> 16) & 0xFF0) | ((curInstruction >> 4) & 0xF)));
            }
        ...
        public void Execute()
        {
            ...
            while (parent.Cycles > 0)
            {
                ...
                {
                    fastDispatch[(ushort)(((curInstruction >> 16) & 0xFF0) | ((curInstruction >> 4) & 0xF))]();
...
//                        this.ExecuteInstruction((ushort)(((this.curInstruction >> 16) & 0xFF0) | ((this.curInstruction >> 4) & 0xF)));
        ...
        {
            // rm lsl immed
            var rm = registers[curInstruction & 0xF];
            var amount = (int)((curInstruction >> 7) & 0x1F);
        ...
        private void ExecuteInstruction(ushort op)
        {
            ...
            switch (op)
            {
                ...
                case 0x009:
                    // MUL rd, rm, rs
                    rd = (curInstruction >> 16) & 0xF;
                    rs = (curInstruction >> 8) & 0xF;
                    rm = curInstruction & 0xF;

                    cycles = MultiplyCycleCalculation(rs);
                ...
                case 0x029:
                    // MLA rd, rm, rs, rn
                    rd = (curInstruction >> 16) & 0xF;
                    rn = registers[(curInstruction >> 12) & 0xF];
                    rs = (curInstruction >> 8) & 0xF;
                    rm = curInstruction & 0xF;
                ...
                case 0x089:
                    // UMULL rdlo, rdhi, rm, rs
                    {
                        ...
                        cycles = MultiplyCycleCalculation(rs) + 1;
                ...
                case 0x0A9:
                    // UMLAL rdlo, rdhi, rm, rs
                    {
                        ...
                        cycles = MultiplyCycleCalculation(rs) + 2;
                ...
                case 0x10B:
                    ...
                    memory.WriteU16(registers[rn] + offset, (ushort)(registers[rd] & 0xFFFF));
                    break;
                ...
                case 0x12B:
                    ...
                    registers[rn] += offset;
                    memory.WriteU16(registers[rn], (ushort)(registers[rd] & 0xFFFF));
                    break;
                ...
                case 0x11B:
                    ...
                    registers[rd] = memory.ReadU16(registers[rn] + offset);
                ...
                case 0x13B:
                    ...
                    registers[rd] = memory.ReadU16(registers[rn]);
                ...
                case 0x01D:
                    ...
                    registers[rd] = (uint)(sbyte)memory.ReadU8(address);
                ...
                case 0x11D:
                    ...
                    registers[rd] = (uint)(sbyte)memory.ReadU8(registers[rn] + offset);
                ...
                case 0x13D:
                    ...
                    registers[rn] += offset;
                    registers[rd] = (uint)(sbyte)memory.ReadU8(registers[rn]);
                ...
                case 0x01F:
                    ...
                    registers[rd] = (uint)(short)memory.ReadU16(address);
                ...
                case 0x11F:
                    ...
                    registers[rd] = (uint)(short)memory.ReadU16(registers[rn] + offset);
                ...
                case 0x13F:
                    ...
                    registers[rn] += offset;
                    registers[rd] = (uint)(short)memory.ReadU16(registers[rn]);
                ...
                case 0x120:
                    // MSR cpsr, rm
                    {
                        rm = registers[curInstruction & 0xF];
                ...
                case 0x160:
                    ...
                    {
                        rm = registers[curInstruction & 0xF];
                        if ((curInstruction & (1 << 16)) == 1 << 16)
                        {
                            parent.SPSR &= 0xFFFFFF00;
                            parent.SPSR |= rm & 0x000000FF;
                        }
                        if ((curInstruction & (1 << 17)) == 1 << 17)
                        {
                            parent.SPSR &= 0xFFFF00FF;
                            parent.SPSR |= rm & 0x0000FF00;
                        }
                        if ((curInstruction & (1 << 18)) == 1 << 18)
                        {
                            parent.SPSR &= 0xFF00FFFF;
                            parent.SPSR |= rm & 0x00FF0000;
                        }
                        if ((curInstruction & (1 << 19)) == 1 << 19)
                        {
                            parent.SPSR &= 0x00FFFFFF;
                            parent.SPSR |= rm & 0xFF000000;
                        }
                    }
                    break;
                ...
                case 0x360:
                    ...
                    if (parent.SPSRExists)
                    {
                        ...
                        {
                            parent.SPSR &= 0xFFFFFF00;
                            parent.SPSR |= immed & 0x000000FF;
                        }
                        if ((curInstruction & (1 << 17)) == 1 << 17)
                        {
                            parent.SPSR &= 0xFFFF00FF;
                            parent.SPSR |= immed & 0x0000FF00;
                        }
                        if ((curInstruction & (1 << 18)) == 1 << 18)
                        {
                            parent.SPSR &= 0xFF00FFFF;
                            parent.SPSR |= immed & 0x00FF0000;
                        }
                        if ((curInstruction & (1 << 19)) == 1 << 19)
                        {
                            parent.SPSR &= 0x00FFFFFF;
                            parent.SPSR |= immed & 0xFF000000;
                        }
                    }
                    break;
                ...
                case 0x408: case 0x409: case 0x40A: case 0x40B: case 0x40C: case 0x40D: case 0x40E: case 0x40F:
                    ...
                    offset = curInstruction & 0xFFF;
                    offset = (uint)-offset;

                    alu = registers[rd];
                    if (rd == 15) alu += 4;

                    memory.WriteU32(registers[rn], alu);
                    registers[rn] += offset;
                    break;
                ...
                case 0x448: case 0x449: case 0x44A: case 0x44B: case 0x44C: case 0x44D: case 0x44E: case 0x44F:
                    ...
                    memory.WriteU8(registers[rn], (byte)(alu & 0xFF));
                    registers[rn] += offset;
                    break;
                ...
                case 0x488: case 0x489: case 0x48A: case 0x48B: case 0x48C: case 0x48D: case 0x48E: case 0x48F:
                    ...
                    memory.WriteU32(registers[rn], alu);
                    registers[rn] += curInstruction & 0xFFF;
                    break;
                ...
                case 0x508: case 0x509: case 0x50A: case 0x50B: case 0x50C: case 0x50D: case 0x50E: case 0x50F:
                    ...
                    memory.WriteU32(registers[rn] + offset, alu);
                    break;
                ...
                case 0x548: case 0x549: case 0x54A: case 0x54B: case 0x54C: case 0x54D: case 0x54E: case 0x54F:
                    ...
                    memory.WriteU8(registers[rn] + offset, (byte)(alu & 0xFF));
                    break;
                ...
                case 0x588: case 0x589: case 0x58A: case 0x58B: case 0x58C: case 0x58D: case 0x58E: case 0x58F:
                    ...
                    memory.WriteU32(registers[rn] + (curInstruction & 0xFFF), alu);
                    break;
                ...
                case 0x5C8: case 0x5C9: case 0x5CA: case 0x5CB: case 0x5CC: case 0x5CD: case 0x5CE: case 0x5CF:
                    ...
                    memory.WriteU8(registers[rn] + (curInstruction & 0xFFF), (byte)(alu & 0xFF));
                    break;
                ...
                case 0x418: case 0x419: case 0x41A: case 0x41B: case 0x41C: case 0x41D: case 0x41E: case 0x41F:
                    ...
                    registers[rd] = memory.ReadU32(registers[rn]);
                ...
                case 0x458: case 0x459: case 0x45A: case 0x45B: case 0x45C: case 0x45D: case 0x45E: case 0x45F:
                    ...
                    registers[rd] = memory.ReadU8(registers[rn]);
                ...
                case 0x518: case 0x519: case 0x51A: case 0x51B: case 0x51C: case 0x51D: case 0x51E: case 0x51F:
                    ...
                    registers[rd] = memory.ReadU32(registers[rn] + offset);
                ...
                case 0x558: case 0x559: case 0x55A: case 0x55B: case 0x55C: case 0x55D: case 0x55E: case 0x55F:
                    ...
                    registers[rd] = memory.ReadU8(registers[rn] + offset);
                ...
                case 0x598: case 0x599: case 0x59A: case 0x59B: case 0x59C: case 0x59D: case 0x59E: case 0x59F:
                    ...
                    registers[rd] = memory.ReadU32(registers[rn] + (curInstruction & 0xFFF));
                ...
                case 0x5D8: case 0x5D9: case 0x5DA: case 0x5DB: case 0x5DC: case 0x5DD: case 0x5DE: case 0x5DF:
                    ...
                    registers[rd] = memory.ReadU8(registers[rn] + (curInstruction & 0xFFF));
                ...
                case 0x688:
                    ...
                    memory.WriteU32(registers[rn], alu);
                    registers[rn] += BarrelShifterLslImmed();
                    break;
                ...
                case 0x68A:
                    ...
                    memory.WriteU32(registers[rn], alu);
                    registers[rn] += BarrelShifterLsrImmed();
                    break;
                ...
                case 0x68C:
                    ...
                    memory.WriteU32(registers[rn], alu);
                    registers[rn] += BarrelShifterAsrImmed();
                    break;
                ...
                case 0x68E:
                    ...
                    memory.WriteU32(registers[rn], alu);
                    registers[rn] += BarrelShifterRorImmed();
                    break;
                ...
                case 0x788:
                    ...
                    memory.WriteU32(registers[rn] + BarrelShifterLslImmed(), alu);
                    break;
                ...
                case 0x78A:
                    ...
                    memory.WriteU32(registers[rn] + BarrelShifterLsrImmed(), alu);
                    break;
                ...
                case 0x78C:
                    ...
                    memory.WriteU32(registers[rn] + BarrelShifterAsrImmed(), alu);
                    break;
                ...
                case 0x78E:
                    ...
                    memory.WriteU32(registers[rn] + BarrelShifterRorImmed(), alu);
                    break;
                ...
                case 0x7C8:
                    ...
                    memory.WriteU8(registers[rn] + BarrelShifterLslImmed(), (byte)(alu & 0xFF));
                    break;
                ...
                case 0x7CA:
                    ...
                    memory.WriteU8(registers[rn] + BarrelShifterLsrImmed(), (byte)(alu & 0xFF));
                    break;
                ...
                case 0x7CC:
                    ...
                    memory.WriteU8(registers[rn] + BarrelShifterAsrImmed(), (byte)(alu & 0xFF));
                    break;
                ...
                case 0x7CE:
                    ...
                    memory.WriteU8(registers[rn] + BarrelShifterRorImmed(), (byte)(alu & 0xFF));
                    break;
                ...
                case 0x798:
                    ...
                    registers[rd] = memory.ReadU32(registers[rn] + BarrelShifterLslImmed());
                ...
                case 0x79A:
                    ...
                    registers[rd] = memory.ReadU32(registers[rn] + BarrelShifterLsrImmed());
                ...
                case 0x79C:
                    ...
                    registers[rd] = memory.ReadU32(registers[rn] + BarrelShifterAsrImmed());
                ...
                case 0x79E:
                    ...
                    registers[rd] = memory.ReadU32(registers[rn] + BarrelShifterRorImmed());
                ...
                case 0x7D8:
                    ...
                    registers[rd] = memory.ReadU8(registers[rn] + BarrelShifterLslImmed());
                ...
                case 0x7DA:
                    ...
                    registers[rd] = memory.ReadU8(registers[rn] + BarrelShifterLsrImmed());
                ...
                case 0x7DC:
                    ...
                    registers[rd] = memory.ReadU8(registers[rn] + BarrelShifterAsrImmed());
                ...
                case 0x7DE:
                    ...
                    registers[rd] = memory.ReadU8(registers[rn] + BarrelShifterRorImmed());
