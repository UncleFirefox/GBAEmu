namespace GarboDev.Cores.InterpretedCore
{
    partial class FastArmCore
    {
        ...
        private void DefaultDispatchFunc() { NormalOps[(curInstruction >> 25) & 0x7](); }
        private ExecuteInstructionDelegate[] fastDispatch;
        private void InitializeDispatchFunc()
        {
            fastDispatch = new ExecuteInstructionDelegate[] {
